...
export { getStaticPaths, getStaticProps } from '@framework/tags.ssr';
    ...
    <div className="border-t-2 border-borderBottom">
      <Container>
        <div className={`flex pt-8 pb-10 lg:pb-16 xl:pb-20`}>
          <div className="flex-shrink-0 hidden ltr:pr-8 rtl:pl-8 ltr:xl:pr-12 ltr:2xl:pr-24 rtl:xl:pl-12 rtl:2xl:pl-24 lg:block w-72 xl:w-80 2xl:w-96">
            <StickyBox offsetTop={50} offsetBottom={20}>
              <div className="pt-1 pb-5 xl:pb-7">
