...
> Compatibility note: this workspace package is sourced from the Andersao
> GitHub repository, but it remains installed as `prettus/l5-repository` and
> keeps the `Prettus\Repository` PHP namespace for backward compatibility.
