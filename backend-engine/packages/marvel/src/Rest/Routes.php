...
use Marvel\Http\Controllers\ZyroTryOnController;
...
Route::group(['middleware' => ['can:' . Permission::CUSTOMER, 'auth:sanctum', 'email.verified']], function () {
    ...
    Route::middleware('throttle:10,1')->group(function () {
        Route::post('zyro/try-on/upload', [ZyroTryOnController::class, 'storePhoto']);
        Route::post('zyro/try-on/task', [ZyroTryOnController::class, 'createTask']);
        Route::get('zyro/try-on/task/{taskId}', [ZyroTryOnController::class, 'showTask']);
    });
