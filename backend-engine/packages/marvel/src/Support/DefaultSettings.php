...
{
    public static function defaults(?string $language = null): array
    {
        ...
        return [
            ...
            "contactDetails" => [
                ...
                "socials" => [
                    [
                        "url" => "https://github.com/Absolute-Martial/Nuvia-Beauty",
                        "icon" => "FacebookIcon",
                    ],
                    [
                ...
                "website" => "https://github.com/Absolute-Martial",
                "emailAddress" => "abscreator@proton.me",
                "location" => [
                    "lat" => 42.9585979,
                    "lng" => -76.9087202,
                    "zip" => null,
            ...
            "guestCheckout" => true,
            "server_info" => static::serverEnvironmentInfo(),
            "useAi" => false,
            "defaultAi" => "openai",
            "maxShopDistance" => 1000,
            "mailchimpSubscribeText" => "Thank you for subscribing",
            "siteLink" => "https://github.com/Absolute-Martial/Nuvia-Beauty",
            "copyrightText" => "MIT License.",
            "externalText" => "GitHub",
            "externalLink" => "https://github.com/Absolute-Martial",
            "reviewSystem" => [
                "value" => "review_single_time",
                "name" => "Give purchased product a review only for one time. (By default)",
            ],
            ...static::smsEmailEvents(),
            ...static::maintenanceSettings(),
            ...static::promoPopupSettings(),
        ];
    }

    protected static function smsEmailEvents(): array
    {
        return [
            "smsEvent" => [
                "admin" => [
    ...
    protected static function maintenanceSettings(): array
    {
        return [
            ...
            "maintenance" => [
                ...
                "start" => Carbon::now()->toJSON(),
                "until" => Carbon::now()->addDay()->toJSON(),
            ],
        ];
    }

    protected static function promoPopupSettings(): array
    {
        return [
            "isPromoPopUp" => true,
            "promoPopup" => [
    ...
    protected static function serverEnvironmentInfo(): array
    {
        if (function_exists('server_environment_info')) {
            return server_environment_info();
        }
