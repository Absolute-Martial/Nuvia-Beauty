...
Maintenance documentation for `admin-panel`.
...
When changing admin code, check:
...
Do not document planned admin functionality as current functionality. Mark unfinished items as `Planned` or `Not implemented yet`.
