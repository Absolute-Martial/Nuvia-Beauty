...
export const siteSettings = {
  ...
  authorizedLinks: [
    ...
    },
    {
      ...
      icon: 'ShopIcon',
      permission: platformAndVendorOwnerOnly,
    },
  ...
  sidebarLinks: {
    vendor: {
      ...
      layout: {
        href: '',
        label: 'text-vendor-content-management',
        icon: 'SettingsIcon',
        childMenu: [
          {
            href: '',
      ...
      user: {
        ...
        childMenu: [
          ...
          },
          {
            ...
            label: 'text-vendor-admin-list',
            icon: 'AdminListIcon',
          },
          {
            href: '',
            label: 'text-vendor-sellers',
            icon: 'VendorsIcon',
            childMenu: [
              {
