export const Routes = {
  ...
  vendorDashboardNotice: '/notice',
  vendorDashboardMessage: '/owner-message',
  vendorDashboardMyShop: '/my-shop',
  ...
  vendorDashboardNotifyLogs: '/notify-logs',
